...
public class Rectangle extends Shape implements GraphicalObject{
	public Rectangle()
	{
		this.left = 0;
		this.top = 0;
	...
	public Rectangle(int left, int top, int width, int height, String color)
	{
		this.left = left; 
		this.top = top;
		this.width = width;
	...
	{
		return String.format("Rectangle(%d, %d, %d, %d)", left, top, width, height);
	}
